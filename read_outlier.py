...
class MnistOutlier:
    def __init__(self, outlier_ratio):
        ...
        self.train_images, self.train_labels, self.if_outlier = get_outlier_with_ratio(outlier_ratio)
        self.test_images, self.test_labels = get_test()
        self.validation_images, self.validation_labels = get_validation()
